def set_template(args):
    args.outf = './exp/' + str(args.dataset_name) + '/' + str(args.mask_type) + '_withloss/' + str(args.method) + args.outf
    # Set the templates here
    if args.method.find('mst') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Phi'

    if args.method.find('ASMNET') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Phi'
    ...
    if args.method.find('MaskfreeDC') >= 0:
        args.input_setting = 'Y'
        args.input_mask = 'Phi_PhiPhiT'
        args.scheduler = 'CosineAnnealingLR'
        args.max_epoch = 300

    if args.method.find('HRFT') >= 0:
        args.input_setting = 'H'
        args.input_mask = 'Phi_PhiPhiT'
        args.scheduler = 'CosineAnnealingLR'
        args.max_epoch = 300
    if args.method.find('in2set') >= 0:
        args.input_setting = 'Y'
        args.input_mask = 'Phi_PhiPhiT'
        args.scheduler = 'CosineAnnealingLR'
        args.max_epoch = 300

    if args.method.find('dauhdc') >= 0:
        args.input_setting = 'Y'
        args.input_mask = 'Phi_PhiPhiT'
        args.scheduler = 'CosineAnnealingLR'
        args.max_epoch = 300

    if args.method.find('LTRN') >= 0:
        args.input_setting = 'Y'
        args.input_mask = 'Phi_PhiPhiT'
        args.scheduler = 'CosineAnnealingLR'
        # args.max_epoch = 200